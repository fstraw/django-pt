...
class NewVisitorTest(unittest.TestCase):
	...
	## She goes to check out the homepage
		self.browser.get('http://localhost:8000/nepa/projects/')
		...
		# She looks for one of her projects and the list is filtered to just the project(s) she needs
		firsttd = rows.find_element_by_class_name('td')
		self.assertTrue(firsttd)
		if inputbox:
			inputbox.send_keys('Heather')
		# self.assertTrue(
